...
export default function UserProfile() {
  ...
  const [patient, setPatient] = useState<Omit<PatientDetailType, "id">>({
    patientname: "",
    age: null,
    gender: "",
    bloodGroup: null,
  ...
  if (!patientData) {
    return (
      <p className="text-center mt-10 text-gray-600">User profile not found</p>
    );
  }
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                onClick={handleAppointmentButton} // replace with actual navigation
              >
                Show Appointments
              </button>
              <button
